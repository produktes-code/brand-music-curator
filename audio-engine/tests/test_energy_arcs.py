...
class TestGenerateEnergyArc:
    ...
    def test_pre_opening_state(self, capsys):
        ...
        assert (
            "Motivación" in result["curation_logic"]
            or "staff" in result["curation_logic"].lower()
        ), (
    ...
    def test_closing_state(self, capsys):
        ...
        assert (
            "salida" in result["curation_logic"].lower()
            or "cierre" in result["curation_logic"].lower()
    ...
    def test_open_low_traffic(self, capsys):
        ...
        assert (
            "Dwell Time" in result["curation_logic"]
            or "permanencia" in result["curation_logic"].lower()
        ), (
    ...
    def test_open_high_traffic(self, capsys):
        ...
        assert (
            "aglomeraciones" in result["curation_logic"].lower()
            or "impulsivas" in result["curation_logic"].lower()
        ), (
    ...
    def test_open_medium_traffic(self, capsys):
        ...
        assert (
            "estándar" in result["curation_logic"].lower()
            or "marca" in result["curation_logic"].lower()
        ), (
    ...
    def test_invalid_state_defaults(self, capsys):
        ...
        assert result["target_bpm_range"] == [100, 120], (
            "Estado desconocido debe usar BPM default [100,120]"
        )
